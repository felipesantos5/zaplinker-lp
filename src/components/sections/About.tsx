  ...
  return (
    <AnimatedSection>
      <div className="container-grid grid md:grid-cols-2 lg:grid-cols-3 px-4 gap-8 mt-10" id="about">
        ...
        <AboutCard icon={<Inbox size={20} />} title={"Organize seus links por projetos"} text={"Organize e otimize a criação dos seus links por projetos."} />
        <AboutCard icon={<UserSearch />} title={"Use UTMs"} text={"Aplique UTMs em seus links e entenda melhor seus resultados."} />
        <AboutCard icon={<RiQrCodeLine size={22} />} title={"QR Code"} text={"Crie QR Codes para seus links. Compartilhe seus links de forma offline e aumente a taxa de conversão."} />
      </div>
    </AnimatedSection>
  )
}