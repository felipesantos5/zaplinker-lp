...
export const Cta = () => {
  return (
    <AnimatedSection className='container-grid pb-24 pt-40 flex flex-col items-center'>
      <BlurIn word="Links fracos limitam seu alcace" className='text-4xl sm:text-5xl font-semibold tracking-tight text-center md:text-7xl max-w-2xl'></BlurIn>
