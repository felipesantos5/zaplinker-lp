...
export const Cta = () => {
  return (
    <AnimatedSection className='container-grid pb-24 pt-44 flex flex-col items-center'>
      ...
      <h1 className='text-4xl sm:text-5xl font-medium tracking-tight text-center md:text-7xl max-w-2xl'><span className='title'>Links</span> fracos limitam seu <span className='title'>alcace</span></h1>
